...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const localizedUrl = `${SITE_URL}${localePrefix}/6-month-cd-calculator`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        en: `${SITE_URL}/6-month-cd-calculator`,
        es: `${SITE_URL}/es/6-month-cd-calculator`,
        'x-default': `${SITE_URL}/6-month-cd-calculator`,
      },
    },
    openGraph: {
      type: 'website',
...
export default async function SixMonthPage({ params }: PageProps) {
