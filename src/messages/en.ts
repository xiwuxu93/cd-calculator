...
`,
    ...
    glossaryTitle: "CD Key Terms & Definitions",
    glossaryApy: "**APY (Annual Percentage Yield):** The real rate of return earned on an investment, taking into account the effect of compounding interest.",
    glossaryApr: "**APR (Annual Percentage Rate):** The annual rate of interest without taking compounding into account.",
    glossaryPrincipal: "**Principal:** The initial amount of money you deposit into the CD.",
    glossaryMaturity: "**Maturity Date:** The specific date when the CD term ends and you can withdraw your funds without penalty.",
