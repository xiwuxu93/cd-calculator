const es = {
  ...
  calculator: {
    ...
    payoutModeLabel: "Pago de intereses",
    payoutModeCompound: "Reinvertir (Compuesto)",
    payoutModeWithdraw: "Retirar (Simple)",
    ...
    periodicPayout: "Ingreso Mensual Est.",
  ...
  home: {
    ...
    toolJumbo: "Calculadora de CD Jumbo",
    ctaTitle:
  ...
  jumboPage: {
    title: "Calculadora de CD Jumbo - Intereses para depósitos de +$100k",
    description: "Calcule las ganancias de los CD Jumbo. Diseñado para certificados de depósito de alto saldo ($100,000 o más) con opciones de capitalización.",
    keywords: "calculadora cd jumbo, tasas cd jumbo, intereses cd 100k, certificado deposito alto rendimiento",
    aboutTitle: "¿Qué es un CD Jumbo?",
    aboutContent: "Un CD Jumbo es un certificado de depósito que requiere un depósito mínimo mayor, generalmente **$100,000** o más. A cambio de comprometer una suma mayor de dinero, los bancos históricamente ofrecían tasas de interés más altas que los CD estándar, aunque hoy en día las tasas suelen ser competitivas con los CD estándar de alto rendimiento.",
    insuranceTitle: "¿Son seguros los CD Jumbo?",
    insuranceContent: "Sí, los CD Jumbo son seguros siempre que se mantengan en un banco asegurado por la FDIC o una cooperativa de crédito asegurada por la NCUA. El límite estándar de seguro es de **$250,000 por depositante, por institución**. Si invierte más de esta cantidad en un solo CD Jumbo, la parte que exceda los $250,000 puede no estar asegurada. Los inversores con sumas muy grandes a menudo distribuyen sus fondos en varios bancos para mantener la cobertura completa.",
  },
  privacy: {
