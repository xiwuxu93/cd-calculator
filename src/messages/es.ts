const es = {
  metadata: {
    title:
      "Calculadora de Tasas de CD 2026 - Interés de CD Gratis",
    description:
      "Compara tasas de CD y calcula intereses con nuestra calculadora de tasas de CD gratuita. Estima el valor al vencimiento, el TAE (APY) y los rendimientos.",
    keywords:
      "calculadora de tasas de cd, calculadora de cd, calculadora de intereses de cd, comparar tasas de cd, calculadora de certificados de depósito, calculadora de ahorros",
  ...
  howToPage: {
    ...
    manualTitle: "Cómo Calcular el Interés de un CD Manualmente",
    manualContent: "Para calcular el interés de un CD manualmente, siga estos sencillos pasos matemáticos:\n\n1. Divida la tasa de interés anual (r) por la frecuencia de capitalización (n). Por ejemplo, una tasa de interés del 5% capitalizable mensualmente es `0.05 / 12 = 0.004167`.\n2. Sume 1 a este número. Ej., `1 + 0.004167 = 1.004167`.\n3. Multiplique la frecuencia de capitalización (n) por el plazo en años (t) para obtener los períodos totales. Para un CD a 1 año, esto es `12 * 1 = 12`.\n4. Eleve el resultado del Paso 2 a la potencia del número del Paso 3. Ej., `(1.004167)^12 ≈ 1.051162`.\n5. Multiplique el resultado por el capital inicial (P). Ej., `$10,000 * 1.051162 = $10,511.62`.\n6. Reste el capital del valor total al vencimiento para obtener el interés ganado: `$10,511.62 - $10,000 = $511.62`.",
    apyTitle: "Cómo Calcular el APY y el APR en un CD",
    apyContent: "Es importante distinguir entre **APR (Tasa Porcentual Anual)**, que es la tasa de interés nominal, y **APY (Rendimiento Porcentual Anual)**, que tiene en cuenta la capitalización. Para calcular el APY a partir del APR, use la fórmula:\n\n`APY = (1 + APR / n)^n - 1`\n\nPor ejemplo, si un banco ofrece un CD con un APR del 4.90% capitalizable diariamente (n=365), el APY se calcula como `(1 + 0.049 / 365)^365 - 1 = 5.02%`. Saber cómo calcular las tasas de CD y el APY le permite comparar con precisión diferentes cuentas de CD.",
    taxAvoidTitle: "Cómo Evitar Impuestos sobre el Interés de un CD",
    taxAvoidContent: "El interés del CD se grava como ingreso regular en el año en que se gana. Si desea saber cómo evitar impuestos sobre el interés del CD, puede utilizar estas estrategias legales:\n\n*   **Use cuentas de jubilación:** Abra un **[CD IRA](/es/ira-cd-calculator)**. Los CD IRA tradicionales permiten el crecimiento con impuestos diferidos, lo que significa que solo paga impuestos cuando retira fondos en la jubilación. Los CD IRA Roth ofrecen un crecimiento completamente libre de impuestos.\n*   **Compense con la recolección de pérdidas fiscales:** Si tiene pérdidas de capital en una cuenta de corretaje sujeta a impuestos, puede usarlas para compensar hasta $3,000 de ingresos ordinarios, incluido el interés del CD.\n*   **Use cuentas de ahorro para la salud (HSA):** Si su proveedor de HSA ofrece una opción de CD, el interés crece libre de impuestos cuando se usa para gastos médicos calificados.",
    dailyTitle: "Cómo Calcular el Interés de un CD Capitalizado Diariamente",
    dailyContent: "Muchos bancos de ahorro de alto rendimiento utilizan la capitalización diaria (n=365 o a veces n=360). La fórmula para la capitalización diaria es:\n\n`A = P * (1 + r/365)^(365*t)`\n\nPara un CD de 6 meses (t=0.5) con un capital de $10,000 y una tasa del 5.00% APR, el cálculo es `$10,000 * (1 + 0.05/365)^(365 * 0.5) ≈ $10,253.15`. Esto genera `$253.15` en intereses, ligeramente superior al interés simple ($250.00).",
  },
  taxPage: {
    title: "Calculadora de Impuestos de CD - Calcule el Interés Neto del CD",
    description: "Calcule cómo los impuestos federales y estatales afectan las ganancias de su Certificado de Depósito. Estime su interés neto, responsabilidad fiscal y TAE (APY) después de impuestos.",
    keywords: "calculadora de impuestos de cd, impuestos sobre intereses de cd, interes neto de cd",
    aboutTitle: "Cómo se Gravan los Intereses de los CD",
    aboutContent: "Los intereses ganados de un Certificado de Depósito (CD) se consideran ingresos gravables por el IRS y generalmente se gravan a su tasa impositiva marginal sobre ingresos ordinarios, en lugar de las tasas más bajas para ganancias de capital a largo plazo. Esto significa que el rendimiento real que se lleva a casa es menor que el APY anunciado. \n\nNuestra **Calculadora de Impuestos de CD** le ayuda a estimar sus ganancias netas aplicando su tasa impositiva marginal al interés total ganado. Esto es esencial para planificar los ingresos de jubilación y comparar los CD con opciones de inversión exentas de impuestos, como los bonos municipales.",
    strategiesTitle: "Estrategias para Minimizar los Impuestos de los CD",
    strategiesContent: "Si desea reducir la carga fiscal sobre sus ahorros, considere estas estrategias:\n\n1.  **CD IRA:** Abrir un **[CD IRA](/es/ira-cd-calculator)** tradicional o Roth protege sus intereses de la tributación anual. Los CD IRA tradicionales difieren los impuestos hasta el retiro, mientras que los CD IRA Roth ofrecen un crecimiento completamente libre de impuestos.\n2.  **Bonos Municipales:** Si se encuentra en un tramo impositivo alto, los intereses de los bonos municipales están exentos de impuestos federales (y a menudo estatales), lo que puede generar un rendimiento neto más alto que un CD sujeto a impuestos.\n3.  **Planificación de Retiros:** Para los CD de varios años, los intereses generalmente están sujetos a impuestos en el año en que se acreditan en su cuenta. Planifique sus flujos de efectivo para que la responsabilidad fiscal no lo empuje a un tramo impositivo más alto en un solo año.",
  },
  monthlyPage: {
    title: "Calculadora de Interés Mensual de CD - Estime Pagos",
    description: "Calcule cuántos ingresos mensuales puede recibir de un Certificado de Depósito. Compare los pagos mensuales con el valor al vencimiento capitalizado.",
    keywords: "calculadora de interes mensual de cd, calculadora de pagos de cd, interes mensual de cd",
    aboutTitle: "Cómo Funcionan los Pagos de Intereses Mensuales de CD",
    aboutContent: "La mayoría de los bancos le permiten elegir cómo desea que se distribuyan los intereses de su Certificado de Depósito (CD). Aunque la opción predeterminada es dejar que los intereses se capitalicen (se reinviertan en el CD), puede solicitar que se le paguen mensualmente en una cuenta corriente o de ahorros vinculada. \n\nEsta es una opción popular para jubilados e inversores que buscan un flujo regular de ingresos pasivos. Sin embargo, es fundamental comprender que **retirar sus intereses mensualmente reduce su rendimiento general**. Al retirar los intereses, evita que se capitalicen (ganar intereses sobre intereses), lo que significa que gana la tasa de interés nominal (APR) en lugar del rendimiento porcentual anual (APY) anunciado.",
    comparisonTitle: "Comparación de Capitalización vs. Pago Mensual",
    comparisonContent: "Comparemos las ganancias de un **CD de $100,000** con un **5.00% APY** durante un plazo de 12 meses:\n\n*   **Opción de Capitalización:** Los intereses permanecen en el CD. Al vencimiento, recibe **$105,000.00** ($5,000.00 de interés total).\n*   **Opción de Pago Mensual:** Recibe aproximadamente **$407.41** cada mes. Durante 12 meses, su interés total pagado es de **$4,888.92**.\n\nAl tomar el pago mensual, pierde **$111.08** en intereses compuestos, pero gana liquidez y un flujo de ingresos regular.",
  },
  threeMonthPage: {
    title: "Calculadora de CD a 3 Meses - Interés de CD a Corto Plazo",
    description: "Calcule sus ganancias para un Certificado de Depósito de 3 meses. Compare las tasas de interés de CD a corto plazo y vea cuánto pueden crecer sus ahorros.",
    keywords: "calculadora de cd a 3 meses, calculadora de cd a corto plazo, interes de cd a 3 meses",
    aboutTitle: "Sobre los CD a 3 Meses",
    aboutContent: "Un CD a 3 meses es un vehículo de ahorro a muy corto plazo que bloquea sus fondos durante exactamente tres meses (normalmente alrededor de 90 días). Ofrece un rendimiento fijo y garantizado, lo que lo convierte en un lugar muy seguro para mantener el dinero en efectivo que necesita en un futuro cercano y, al mismo tiempo, ganar más intereses que una cuenta corriente estándar.",
    advantagesTitle: "¿Por qué elegir un CD a 3 meses?",
    advantagesContent: "- **Liquidez muy alta:** Los fondos se bloquean por solo 90 días, lo que proporciona un acceso rápido al efectivo en comparación con los CD a 1 o 5 años.\n- **Flexibilidad de tasas:** Ideal en un entorno de tasas de interés al alza, lo que le permite reinvirte a tasas más altas rápidamente.\n- **Riesgo cero:** El capital y los intereses están totalmente protegidos por el seguro de la FDIC.",
  },
  compoundPage: {
    title: "Calculadora de Interés Compuesto de CD - Rendimiento Diario vs. Mensual",
    description: "Calcule el interés compuesto de su Certificado de Depósito. Compare las frecuencias de capitalización diaria, mensual, trimestral y anual para maximizar sus rendimientos.",
    keywords: "calculadora de interes compuesto de cd, interes compuesto de cd, capitalizacion diaria cd",
    aboutTitle: "El Poder de la Frecuencia de Capitalización del CD",
    aboutContent: "La frecuencia de capitalización determina con qué frecuencia se vuelven a sumar los intereses ganados al saldo de su capital. Cuanto más frecuentemente se capitalicen los intereses, más rápido crecerán sus ahorros, porque gana 'intereses sobre intereses'. \n\nLa mayoría de los CD modernos de alto rendimiento capitalizan los intereses **diariamente** y los acreditan en su cuenta **mensualmente**. Sin embargo, algunos bancos tradicionales todavía capitalizan mensualmente, trimestralmente o anualmente. Nuestra **Calculadora de Interés Compuesto de CD** le permite ver la diferencia financiera exacta entre estas frecuencias de capitalización para que pueda elegir el mejor producto de CD.",
    comparisonTitle: "Comparación de Rendimiento de la Frecuencia de Capitalización",
    comparisonContent: "Así es como crece un **depósito de $10,000** a una tasa de interés nominal de **5.00% APR** durante un **plazo de 5 años** bajo diferentes frecuencias de capitalización:\n\n*   **Capitalización Diaria (365/año):** Genera **$12,840.03** ($2,840.03 de interés ganado, APY efectivo: **5.13%**).\n*   **Capitalización Mensual (12/año):** Genera **$12,833.59** ($2,833.59 de interés ganado, APY efectivo: **5.12%**).\n*   **Capitalización Trimestral (4/año):** Genera **$12,820.37** ($2,820.37 de interés ganado, APY efectivo: **5.09%**).\n*   **Capitalización Anual (1/año):** Genera **$12,762.82** ($2,762.82 de interés ganado, APY efectivo: **5.00%**).\n\nLa capitalización diaria le genera **$77.21 más** que la capitalización anual para la misma tasa de interés. La diferencia se vuelve aún mayor con montos de depósito más altos y plazos más largos.",
  },
  sixMonthPage: {
  ...
  common: {
    ...
    footer: {
      ...
      taxCalculator: "Calculadora de Impuestos de CD",
  ...
  home: {
    ...
    toolTax: "Calculadora de Impuestos de CD",
    toolTaxDesc: "Calcule el interés neto y rendimiento después de impuestos.",
    toolMonthly: "Calculadora de Interés Mensual",
    toolMonthlyDesc: "Calcule los rendimientos de pago mensual.",
    toolThreeMonth: "CD de 3 Meses",
